			...
			array(
				...
				'fields'          => array(
					array(
						...
						'content' => __( 'Want to easily customize everything (Typography, Colors, Margin)?', 'post-carousel' ) . ' <a href="https://wpsmartpost.com/pricing/?ref=1" target="_blank"><b>' . __( 'Upgrade To Pro!', 'post-carousel' ) . '</b></a> ' . __( 'P.S. Note: The color fields work in the lite version.', 'post-carousel' ),
					),
					array(
